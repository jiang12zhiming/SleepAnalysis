...
extension InterfaceController: HKWorkoutSessionDelegate {
    ...
    func updateHeartRate(_ samples: [HKSample]?) {
        //        let healthData : MotionDataSet = NSEntityDescription.insertNewObject(forEntityName: "MotionDataSet", into: DataAccessControllerWatch.getContext()) as! MotionDataSet
        ...
        DispatchQueue.main.sync {
            ...
            healthData.timeStamp = Int64(Date().timeIntervalSince1970)
            //print(healthData.heartRate, "<------in CoreData")
            print(healthData.timeStamp, "<------time stamp")
        }
    }
}
